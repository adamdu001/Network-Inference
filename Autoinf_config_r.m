% Autoinf showing r with runs of frequency configuration
function f = Autoinf_config_r(exp,run,A,N,T,n,omega,y0,K,samples,threshold)
    ...
    for i = 1:samples
        ...
        % y_samples_vs_run{i,run} = y; % for recording y
        y_samples_vs_run{i,run,exp} = y;
    end
